...
public class ProfileService {
    ...
    public static String getProfileUrl(int userId) {
        try {
            ...
            URL url = new URI("http://localhost:8080/Chatty/profile-images/" + userId + "/profile.png").toURL(); // java.net.URL
            ...
            if (responseCode == HttpURLConnection.HTTP_OK) {
                profile = ChatService.URL + "/Chatty/profile-images/" + userId + "/profile.png";
            } else {
                profile = "";
            }
            return profile;
